...
function requestWebsite(airport) {
    var options = {
        url: "http://192.168.0.254:7000/www.liveatc.net/search/?icao=" + airport,
        timeout: 0,
...
function writeFile() {
    fs.writeFileSync('output_json/liveatc.json', JSON.stringify(json, 0, 4))
    sortJson.overwrite('output_json//liveatc.json');
